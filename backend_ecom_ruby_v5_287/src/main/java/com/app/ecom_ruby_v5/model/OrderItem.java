...
@Table(name = "\"OrderItem\"", schema =  "\"ecom_ruby_v5\"")
@Data
...
public class OrderItem {
  ...
  private String order_item_status;
	...
	@JoinColumn(name = "\"OrderItemOIProduct\"", referencedColumnName = "\"Product_id\"", insertable = false, updatable = false)
	private Product oIProduct;
	
	@Column(name = "\"OrderItemOIProduct\"")
	private Integer orderItemOIProduct;
